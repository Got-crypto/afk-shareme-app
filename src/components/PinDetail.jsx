            ...
            <div className="flex xl:flex-row flex-col m-auto bg-white" style={{maxWidth: '1500px', borderRadius: '32px'}} >
                ...
                <div className="w-full p-5 flex-1 xl:min-w-620 ">
                    <div className="flex items-center justify-between">
                        ...
                        <a href={pinDetails.destination} className="hover:underline" target='_blank' rel="noreferrer">
                    ...
                    <Link to={`user-profile/${pinDetails.postedBy?._id}`} className="flex gap-2 mt-5 items-center bg-white rounded-lg">
                        <img 
                            ...
                            alt="user-profile"
                        />
                        <p className="font-semibold capitalize text-sm font-mono"> {pinDetails.postedBy?.userName} </p>
                    </Link>
                    ...
                    <button
                        type="button"
                        className="bg-red-500 text-white rounded-full px-6 pt-2 font-semibold text-base outline-none"
                        onClick={addComment}
                    >
